...
<body data-home-page="Page-1.html" data-home-page-title="Page 1" class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-align-center u-border-1 u-border-grey-75 u-clearfix u-container-align-center-lg u-container-align-center-md u-container-align-center-sm u-container-align-center-xl u-image u-image-contain u-shading u-section-1" id="carousel_af4f" data-image-width="2000" data-image-height="1333">
      <img src="images/jhj.jpg" class="u-align-left u-expanded-width u-image u-left-0 u-image-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-image-width="1800" data-image-height="987">
        ...
        <div class="u-repeater u-repeater-1">
          <div class="u-container-align-center u-container-style u-custom-item u-list-item u-palette-1-base u-repeater-item u-list-item-1" data-animation-name="customAnimationIn" data-animation-duration="1500">
            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-1"><span class="u-align-center u-icon u-icon-circle u-text-white u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 611.996 611.996" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-dbcb"></use></svg><svg class="u-svg-content" viewBox="0 0 611.996 611.996" x="0px" y="0px" id="svg-dbcb" style="enable-background:new 0 0 611.996 611.996;"><g><g><path d="M588.63,113.193L213.812,33.871c-15.858-3.355-31.576,6.876-34.931,22.734l-7.121,45.762l432.477,91.519l7.121-45.762    C614.713,132.272,604.488,116.549,588.63,113.193z"></path><path d="M431.009,203.591c-4.378-15.766-20.854-25.085-36.615-20.714L323.24,202.63l-167.742-35.5l-18.448,87.165L21.786,286.287    c-15.76,4.372-25.079,20.848-20.708,36.609l64.958,234.078c4.378,15.76,20.855,25.085,36.615,20.708l372.608-103.403    c15.76-4.378,25.079-20.848,20.708-36.615l-11.15-40.184l41.789,8.835c15.858,3.361,31.576-6.87,34.931-22.728l26.439-124.937    L437.45,226.797L431.009,203.591z M474.04,322.559l9.215-43.552c1.384-6.521,7.85-10.727,14.37-9.35l43.552,9.221    c6.527,1.384,10.733,7.843,9.356,14.37l-9.215,43.552c-1.384,6.521-7.849,10.733-14.37,9.35l-43.552-9.215    C476.863,335.546,472.656,329.08,474.04,322.559z M28.27,309.646l103.115-28.606l243.299-67.517l26.181-7.274    c0.478-0.129,0.955-0.19,1.421-0.19c2.1,0,4.611,1.378,5.345,4.017l3.074,11.07l9.631,34.704L37.148,362.186l-12.705-45.768    C23.647,313.546,25.399,310.442,28.27,309.646z M472.601,444.141c0.49,1.776-0.024,3.245-0.545,4.164    c-0.514,0.918-1.506,2.119-3.282,2.608L96.173,554.316c-0.471,0.129-0.955,0.196-1.421,0.196c-2.1,0-4.611-1.384-5.345-4.023    L51.519,413.955l383.188-106.342l23.371,84.208L472.601,444.141z"></path><path d="M156.379,453.484c-1.788-6.429-8.499-10.225-14.928-8.443l-43.515,12.08c-6.423,1.782-10.225,8.499-8.437,14.928    l12.074,43.509c1.788,6.429,8.499,10.225,14.928,8.437l43.515-12.074c6.429-1.782,10.225-8.499,8.443-14.928L156.379,453.484z"></path>
              ...
              <h3 class="u-align-center u-text u-text-body-alt-color u-text-1">Easy Buy</h3>
          ...
          <div class="u-container-align-center u-container-style u-custom-item u-list-item u-palette-2-base u-repeater-item u-list-item-2" data-animation-name="customAnimationIn" data-animation-duration="1500">
            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-2"><span class="u-align-center u-file-icon u-icon u-icon-circle u-text-white u-icon-2"><img src="images/6570894-6dfac3a7.png" alt=""></span>
              <h3 class="u-align-center u-text u-text-body-alt-color u-text-3"> Own Car Advertisement</h3>
              <p class="u-align-center u-text u-text-body-alt-color u-text-4"> Sell Preowned Cars</p>
            </div>
          </div>
          <div class="u-container-align-center u-container-style u-custom-item u-list-item u-palette-3-base u-repeater-item u-list-item-3" data-animation-name="customAnimationIn" data-animation-duration="1500">
            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-3"><span class="u-align-center u-file-icon u-icon u-icon-circle u-text-white u-icon-3"><img src="images/3451422-68ae1153.png" alt=""></span>
              <h3 class="u-align-center u-text u-text-body-alt-color u-text-5"> Buy Cars</h3>
        ...
        <div class="col">
          <div class="card-deck">
            <div class="row justify-content-start ">
              <c:forEach var="carItems" items="${cars}">
                <div class="col my-4">
                  <div class="card d-inline-block" style="width: 16rem;">
                    ...
                    <div class="card-body">
                      ...
                      <span>${carItems.kmDriven}Km</span>&nbsp;&nbsp;&nbsp;&nbsp;
                      <i class="fa-solid fa-location-dot">&nbsp;</i><span>${carItems.rtoLocation}</span>
                      <p class="card-text">Price: ${carItems.price}</p>
                      <!-- <p class="card-text">${carItems.carBrandId.variantId.fuelTypeId.fuelTypeId}</p> -->
                      <p>
                        <c:choose>
                          <c:when test="${user eq null && client eq null}">
                            <a href="user_login.jsp" class="btn btn-outline-info">Contact Seller</a>
                          </c:when>
                          <c:otherwise>
                            <!-- <a href="add_cart.do" class="btn btn-outline-info btn-sm">
                            </a> &nbsp;&nbsp;&nbsp; -->
                            <a href="user_car_details.do?detail=1&car_id=${carItems.carId}&car_name=${carItems.name}&car_brand=${carItems.carBrandId.carBrandId}&avrg=${carItems.average}&regDt=${carItems.regDate}&km_drv=${carItems.kmDriven}&prc=${carItems.price}&stts=${carItems.statusId.statusId}&usr_id=${carItems.userId.userId}&vchl_no=${carItems.vechicleNo}&pic=${carItems.carPicId.carPicId}&loc=${carItems.rtoLocation}&owner=${carItems.owner}" class="btn btn-outline-info btn-sm">
                              Add Cart
                            </a>
                            <a href="user_car_details.do?detail=2&car_id=${carItems.carId}&car_name=${carItems.name}&car_brand=${carItems.carBrandId.carBrandId}&avrg=${carItems.average}&regDt=${carItems.regDate}&km_drv=${carItems.kmDriven}&prc=${carItems.price}&stts=${carItems.statusId.statusId}&usr_id=${carItems.userId.userId}&vchl_no=${carItems.vechicleNo}&pic=${carItems.carPicId.carPicId}&loc=${carItems.rtoLocation}&owner=${carItems.owner}" class="btn btn-outline-info btn-sm">
                              Contact Seller
                            </a>
                          </c:otherwise>
                        </c:choose>
  ...
  <!-- Apna Code -->
    ...
    <section class="u-clearfix u-grey-10 u-section-2" id="sec-a25a">
    ...
    <section class="u-clearfix u-section-3" id="carousel_8cc6">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-sheet-1">
        <div class="u-gradient u-radius-20 u-shape u-shape-round u-shape-1" data-animation-name="pulse" data-animation-duration="1750" data-animation-direction="" data-animation-delay="500"></div>
        <img src="images/ty.jpg" alt="" class="u-image u-image-default u-image-1" data-image-width="1380" data-image-height="920" data-animation-name="customAnimationIn" data-animation-duration="1500">
        <div class="u-container-style u-expanded-width-xs u-group u-white u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-text u-text-1"> Buy or Sell<br>the perfect car
            </h2>
            <p class="u-text u-text-2"><b>Easy way to buy or sell the cars through our platform. </b>
              <br>
              <span class="u-text-grey-50">
                <br>We are here to sell the cars from trusted dealers and the indivisual users. The user can't go to garages he/she will easily find the cars.
              </span>
            </p>
            <a href="https://nicepage.studio" class="u-active-palette-1-dark-2 u-align-center u-border-active-palette-2-light-2 u-border-hover-palette-2-light-2 u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-hover-palette-1-dark-2 u-palette-1-base u-radius-50 u-text-active-white u-text-hover-white u-btn-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">Contact Now</a>
            <p class="u-text u-text-3">&nbsp;<a href="https://www.freepik.com/photos/car" class="u-active-none u-border-1 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-2" target="_blank">&nbsp;&nbsp;</a>
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-container-align-center u-palette-3-base u-section-4" id="carousel_52a4">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <h2 class="u-align-center u-text u-text-default u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500"> Cars Information</h2>
        <p class="u-align-center u-text u-text-2" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">Trusted Car buyers and sellers in our platform&nbsp;<br>An auto resale project is a web application developed for users to post their ads for vehicle resale . Our System overcomes the problem of searching for a second Hand Vechicle
        </p>
        <p class="u-text u-text-default u-text-3" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">&nbsp;&nbsp;</p>
        <a href="#" class="u-active-palette-3-light-1 u-align-center u-border-active-palette-2-light-2 u-border-hover-palette-2-light-2 u-border-none u-btn u-btn-round u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-hover-palette-3-light-1 u-radius-50 u-text-active-white u-text-hover-white u-text-palette-3-base u-white u-btn-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500" data-animation-direction="">Learn more</a>
      </div>
    </section>
